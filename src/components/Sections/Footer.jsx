...
const Footer = () => {
  ...
  return (
    ...
    >
        ...
        <motion.div
            style={{y: scrollY}}
            className="absolute inset-0 oveflow-hidden pointer-events-none"
        >
            <div
                ...
                >
                    <motion.div variants={itemVariants} className="space-y-4">
                        <motion.div
                            ...
                            transition={{type: "string", stiffness: 400}}
                        >
                            <motion.div
                                animate= {{rotate: 360}}
                            ...
                            <span className="">Lipika Arya</span>
                        </motion.div>
                        <motion.p
                    ...
                    <motion.div variants={itemVariants} className="space-y-2">
                        <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-600"}`}>
                            ©{new Date().getFullYear()} Lipika Arya. All Rights Reserved.
                        </p>
