...
const HeroSection = () => {
  ...
  return (
    ...
    >
        ...
        >
            <div className="absolute inset-0 oveflow-hiiden">
                <motion.div 
                    animate={{
                        scale: [1,1.1,1],
                        rotate: [0,180,360]
            ...
            <div className="max-w-7xl mx-auto w-full z-10 mt-12">
                    ...
                    >
                        ...
                        >
                            <motion.button
                                ...
                                className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                            >
                                View Resume
                            </motion.button>
                            <motion.button
                        ...
                        >
                            {[
                                {icon: FiGithub, href:"https://github.com/lipika1911"},
                                {icon: FiLinkedin, href:"https://www.linkedin.com/in/lipika-arya-a6767824b/"},
                                {icon: Mail, href:"mailto:lipikaarya1723@gmail.com"},
                            ].map((social, index) => (
                                <motion.a
                                    key={index}
                                    href={social.href}
                ...
                {/* Desktop Layout */}
                <div className="hidden lg:grid lg:grid-cols-2 lg:gap-x-70 lg:items-center px-6 py-4">
                    {/* left column */}
                    <motion.div
                        initial="hidden"
                        animate="visible"
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="flex gap-6 mb-8">
                            <motion.button
                                whileHover={{y: -2}}
                                whileTap={{scale: 0.98}}
                                onClick={() => window.open("/resume-aug.pdf", "_blank")}
                                className="bg-green-500 hover:bg-green-600 text-white min-w-[180px] px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                            >
                                View Resume
                            </motion.button>
                            <motion.button
                                ...
                                whileTap={{scale: 0.98}}
                                onClick={()=>scrollToSection("work")}
                                className="bg-blue-500 hover:bg-blue-600 text-white min-w-[180px] px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                            >
                                View Work
                            </motion.button>
                            <motion.button
                                ...
                                className={`border ${
                                    ...
                                    ? "border-gray-700 hover:border-gray-600 text-gray-300"
                                    : "border-gray-300 hover:border-gray-400 text-gray-700"
                                } px-8 py-4 rounded-full text-sm min-w-[180px] uppercase tracking-wider font-medium transition-all duration-300`}
                            >
                                Get in Touch
                            </motion.button>
                        </motion.div>
                    ...
                    >
                        <div className="relative">
                            <motion.div
                                variants={itemVariants}
                                className="flex items-center space-x-6 text-xs uppercase tracking-widest absolute -top-16 -left-14"
                            >
                                <span
                                    className={isDarkMode ? "text-gray-600" : "text-gray-500"}
                                >
                                ...
                                <span
                                    className={` ${isDarkMode ? "text-gray-700" : "text-gray-400"} font-extrabold size-4`}
                                >
                                    •
                                </span>
                                <span
